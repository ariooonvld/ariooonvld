    ...
    return {
      ...
      indicatorList: [
        ...
        { isActive: false, id: "#Somedia", title: "Sekolah", linkId: "3" },
        {
          isActive: false,
          id: "#ContactManager",
          title: "Walikota Jakarta Selatan",
          linkId: "4",
        },
        {
          isActive: false,
          id: "#MemoryGame",
          title: "Pt. Officia Sinergy",
          linkId: "5",
        },
        {
          isActive: false,
      ...
      backgrounds: [
        {
          url: "https://images.unsplash.com/photo-1516637090014-cb1ab78511f5?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        },
      ],
      postedBy: [
        {
